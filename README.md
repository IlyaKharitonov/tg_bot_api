...
[![Go Reference](https://pkg.go.dev/badge/github.com/botNotebook/pkg/tgbotapi.svg)](https://pkg.go.dev/github.com/botNotebook/pkg/tgbotapi)
...
All methods are fairly self-explanatory, and reading the [godoc](https://pkg.go.dev/github.com/botNotebook/pkg/tgbotapi) page should
...
`go get -u github.com/botNotebook/pkg/tgbotapi`.
...
import (
	...
	tgbotapi "github.com/botNotebook/pkg/tgbotapi"
)
...
import (
	...
	"github.com/botNotebook/pkg/tgbotapi"
)
